...
public class MeshMerger : MonoBehaviour
{
    ...
    //----------------------------------------------------------------------------
     public void  MergeMesh(bool materialFromfilter)
    {
        if (materialFromfilter && meshFilters.Length > 0) material = meshFilters[0].GetComponent<MeshRenderer>().material;
        ...
        foreach (MeshFilter mf in meshFilters)
        {
            ...
            if (material == null)
                material = mf.GetComponent<Renderer>().material;
        }
